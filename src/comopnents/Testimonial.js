...
export default function Testimonial(props) {
  ...
  return (
    <div className='w-[100vw] md:[700px] bg-white flex flex-col justify-center  items-center mt-10 p-10 transition-all duration-700  hover:shadow-lg rounded-sm'>
